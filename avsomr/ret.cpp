...
QString Ret::text(Code c)
{
    ...
    case FailedReadFile: {
        return QObject::tr("Failed reading file");
    }
    case FailedClearDir: {
        return QObject::tr("Failed clearing directory");
    }
    case FileNotSupported: {
        return QObject::tr("File not supported");
        // network
    }
    case NetworkError: {
    ...
    case LocalNotInstalled: {
        return QObject::tr("Local OMR engine not installed");
    }
    case LocalInstaling: {
        return QObject::tr("Local OMR engine installing…");
    }
    case LocalFailedExec: {
        return QObject::tr("Failed executing local OMR engine");
    }
    case LocalAlreadyBuilding: {
        return QObject::tr("Local OMR engine already building…");
    }
    case AvsOmrFirst:
    case AvsOmrLast: { }
    break;
...
QString Ret::supportHint(Code c)
{
    ...
    case FileNotSupported: {
        return QObject::tr("Choose another file");
        // network
    }
    case NetworkError: {
        return QObject::tr("Check your internet connection");
    }
    case ServerError: {
        return PleaseTryAgain;
        // local
    ...
    case LocalNotInstalled: {
        return QObject::tr("Try to uncheck and check again to use the local OMR engine");
    }
    case LocalInstaling: {
        return PleaseTryAgain;
    }
