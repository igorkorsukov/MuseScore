...
QString accSymId2MxmlString(const SymId id)
{
    ...
    break;
    case SymId::accidentalQuarterToneFlatStein: {
        s = "quarter-flat";
    }
    break;
    case SymId::accidentalQuarterToneSharpStein: {
        s = "quarter-sharp";
    }
    break;
    case SymId::accidentalKucukMucennebSharp: {
        s = "slash-quarter-sharp";
    }
    break;
    case SymId::accidentalBuyukMucennebSharp: {
        s = "slash-sharp";
    }
    break;
    case SymId::accidentalBakiyeFlat: {
        s = "slash-flat";
    }
    break;
    case SymId::accidentalBuyukMucennebFlat: {
        s = "double-slash-flat";
    }
    break;
    /* TODO
...
QString accidentalType2MxmlString(const AccidentalType type)
{
    ...
    break;
    case AccidentalType::FLAT_SLASH: {
        s = "slash-flat";
    }
    break;
    case AccidentalType::MIRRORED_FLAT: {
        s = "quarter-flat";
    }
    break;
    case AccidentalType::FLAT_ARROW_UP: {
        s = "flat-up";
    }
    break;
    case AccidentalType::NATURAL_ARROW_DOWN: {
        s = "natural-down";
    }
    break;
    case AccidentalType::SHARP_SLASH: {
        s = "quarter-sharp";
    }
    break;
    case AccidentalType::SHARP_ARROW_DOWN: {
        s = "sharp-down";
    }
    break;
    case AccidentalType::NATURAL_ARROW_UP: {
        s = "natural-up";
    }
    break;
    case AccidentalType::MIRRORED_FLAT2: {
        s = "three-quarters-flat";
    }
    break;
    // case AccidentalType::FLAT_FLAT_SLASH:    s = "three-quarters-flat";  break;
    case AccidentalType::FLAT_ARROW_DOWN: {
        s = "flat-down";
    }
    break;
    case AccidentalType::SHARP_SLASH4: {
        s = "three-quarters-sharp";
    }
    break;
    case AccidentalType::SHARP_ARROW_UP: {
        s = "sharp-up";
    }
    break;
    case AccidentalType::SHARP_SLASH3: {
        s = "slash-quarter-sharp";
    }
    break;
    case AccidentalType::FLAT_SLASH2: {
        s = "double-slash-flat";
    }
    break;
    case AccidentalType::SHARP_SLASH2: {
        s = "slash-sharp";
    }
    break;
