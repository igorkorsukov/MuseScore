    ...
    if (tremoloNr) {
        ...
        if (tremoloNr == 1 || tremoloNr == 2 || tremoloNr == 3 || tremoloNr == 4) {
            if (tremoloType == "" || tremoloType == "single") {
                ...
                switch (tremoloNr) {
                case 1: {
                    tremolo->setTremoloType(TremoloType::R8);
                }
                break;
                case 2: {
                    tremolo->setTremoloType(TremoloType::R16);
                }
                break;
                case 3: {
                    tremolo->setTremoloType(TremoloType::R32);
                }
                break;
                case 4: {
                    tremolo->setTremoloType(TremoloType::R64);
                }
                break;
                }
                cr->add(tremolo);
                ...
                if (tremStart) {
                    ...
                    switch (tremoloNr) {
                    case 1: {
                        tremolo->setTremoloType(TremoloType::C8);
                    }
                    break;
                    case 2: {
                        tremolo->setTremoloType(TremoloType::C16);
                    }
                    break;
                    case 3: {
                        tremolo->setTremoloType(TremoloType::C32);
                    }
                    break;
                    case 4: {
                        tremolo->setTremoloType(TremoloType::C64);
                    }
                    break;
                    }
