                    ...
                    while (!currentNote.isNull()) {
                        ...
                        if (currentNote.nodeName() == "Properties") {
                            ...
                            if (midi != "") {
                                ...
                                int musescoreString = staff->part()->instrument()->stringData()->strings() - 1
                                                      - stringNum.toInt();
                                auto pitch = staff->part()->instrument()->stringData()->getPitch(musescoreString,
                                                                                                 fretNumber, nullptr, Fraction(
                                                                                                     0,
                                                                                                     1));
                            ...
                            if (!accentNode.isNull()) {
                                ...
                                switch (value) {
                                case 1: {
                                    symId = SymId::articStaccatoAbove;
                                }
                                break;
                                case 2: {
                                    symId = SymId::articStaccatissimoAbove;
                                }
                                break;
                                case 4: {
                                    symId = SymId::articMarcatoAbove;
                                }
                                break;
                                case 8: {
                                    symId = SymId::articAccentAbove;
                                }
                                break;
                                case 16: {
                                    symId = SymId::articTenutoAbove;
                                }
                                break;
                                }
                                Articulation* art = new Articulation(note->score());
