...
QVariant Chord::getProperty(Pid propertyId) const
{
    ...
    case Pid::STEM_DIRECTION: {
        return QVariant::fromValue<Direction>(stemDirection());
    }
    default:
...
void Chord::toGraceAfter()
{
    switch (noteType()) {
    case NoteType::APPOGGIATURA: {
        setNoteType(NoteType::GRACE8_AFTER);
    }
    break;
    case NoteType::GRACE16: {
        setNoteType(NoteType::GRACE16_AFTER);
    }
    break;
    case NoteType::GRACE32: {
        setNoteType(NoteType::GRACE32_AFTER);
    }
    break;
    default: { }
    break;
