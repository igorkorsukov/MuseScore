...
void Page::drawHeaderFooter(QPainter* p, int area, const QString& ss) const
{
    ...
    switch (area) {
    case 0: {
        flags = Align::LEFT | Align::TOP;
    }
    break;
    case 1: {
        flags = Align::HCENTER | Align::TOP;
    }
    break;
    case 2: {
        flags = Align::RIGHT | Align::TOP;
    }
    break;
    case 3: {
        flags = Align::LEFT | Align::BOTTOM;
    }
    break;
    case 4: {
        flags = Align::HCENTER | Align::BOTTOM;
    }
    break;
    case 5: {
        flags = Align::RIGHT | Align::BOTTOM;
    }
    break;
    }
    text->setAlign(flags);
