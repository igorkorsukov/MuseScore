...
// { Sid::figuredBassFontSize,     "figuredBassFontSize",     QVariant(8.0) },
    ...
    { Sid::titleAlign,                    "titleAlign",                    QVariant::fromValue(
    ...
    { Sid::subTitleAlign,                 "subTitleAlign",                 QVariant::fromValue(
          Align::HCENTER | Align::TOP) },
    ...
    { Sid::composerAlign,                 "composerAlign",                 QVariant::fromValue(
    ...
    { Sid::lyricistAlign,                 "lyricistAlign",                 QVariant::fromValue(
    ...
    { Sid::lhGuitarFingeringAlign,        "lhGuitarFingeringAlign",        QVariant::fromValue(
    ...
    { Sid::longInstrumentAlign,           "longInstrumentAlign",          QVariant::fromValue(
          Align::RIGHT | Align::VCENTER) },
    ...
    { Sid::shortInstrumentAlign,          "shortInstrumentAlign",         QVariant::fromValue(
          Align::RIGHT | Align::VCENTER) },
    ...
    { Sid::dynamicsAlign,                 "dynamicsAlign",                QVariant::fromValue(
          Align::HCENTER | Align::BASELINE) },
    ...
    { Sid::expressionAlign,               "expressionAlign",              QVariant::fromValue(
          Align::LEFT | Align::BASELINE) },
    ...
    { Sid::tempoAlign,                    "tempoAlign",                   QVariant::fromValue(
          Align::LEFT | Align::BASELINE) },
    ...
    { Sid::measureNumberAlign,            "measureNumberAlign",           QVariant::fromValue(
          Align::HCENTER | Align::BASELINE) },
    ...
    { Sid::systemTextAlign,               "systemAlign",                  QVariant::fromValue(
          Align::LEFT | Align::BASELINE) },
    ...
    { Sid::staffTextAlign,                "staffAlign",                   QVariant::fromValue(
          Align::LEFT | Align::BASELINE) },
    ...
    { Sid::rehearsalMarkAlign,            "rehearsalMarkAlign",           QVariant::fromValue(
          Align::HCENTER | Align::BASELINE) },
    ...
    { Sid::repeatLeftAlign,               "repeatLeftAlign",              QVariant::fromValue(
          Align::LEFT | Align::BASELINE) },
    ...
    { Sid::repeatRightAlign,              "repeatRightAlign",             QVariant::fromValue(
          Align::RIGHT | Align::BASELINE) },
    ...
    { Sid::bendAlign,                     "bendAlign",                    QVariant::fromValue(
          Align::LEFT | Align::BASELINE) },
    ...
    { Sid::instrumentChangeAlign,         "instrumentChangeAlign",        QVariant::fromValue(
          Align::LEFT | Align::BASELINE) },
    ...
    { Sid::user1Align,                    "user1Align",
      QVariant::fromValue(Align::LEFT | Align::TOP) },
    ...
    { Sid::letRingTextAlign,              "letRingTextAlign",             QVariant::fromValue(
          Align::LEFT | Align::VCENTER) },
