...
static bool readTextProperties(XmlReader& e, TextBase* t, Element*)
{
    ...
    if (tag == "style") {
        ...
        break;
        case 9: {
            ss = Tid::INSTRUMENT_LONG;
        }
        break;
        case 10: {
            ss = Tid::INSTRUMENT_SHORT;
        }
        break;
        case 11: {
            ss = Tid::INSTRUMENT_EXCERPT;
        }
        break;
    ...
    while (e.readNextStartElement()) {
        ...
        if (tag == "Accidental") {
            ...
            if (ok) {
                ...
                case 25: {
                    at = AccidentalType::SORI;
                }
                break;
                case 26: {
                    at = AccidentalType::KORON;
                }
                break;
                }
...
static void readTremolo(Tremolo* tremolo, XmlReader& e)
{
    ...
    while (e.readNextStartElement()) {
        if (e.name() == "subtype") {
            ...
            switch (sti) {
            default:
            case OldTremoloType::OLD_R8: {
                st = TremoloType::R8;
            }
            break;
            case OldTremoloType::OLD_R16: {
                st = TremoloType::R16;
            }
            break;
            case OldTremoloType::OLD_R32: {
                st = TremoloType::R32;
            }
            break;
            case OldTremoloType::OLD_C8: {
                st = TremoloType::C8;
            }
            break;
            case OldTremoloType::OLD_C16: {
                st = TremoloType::C16;
            }
            break;
            case OldTremoloType::OLD_C32: {
                st = TremoloType::C32;
            }
            break;
            }
