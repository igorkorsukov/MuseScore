...
void KeySig::layout()
{
    ...
    switch (t1) {
    case 7: {
        addLayout(SymId::accidentalSharp, xo + 6.0 * sspread, lines[6]);
        // fall through
    }
    case 6: {
        addLayout(SymId::accidentalSharp, xo + 5.0 * sspread, lines[5]);
        // fall through
    }
    case 5: {
        addLayout(SymId::accidentalSharp, xo + 4.0 * sspread, lines[4]);
        // fall through
    }
    case 4: {
        addLayout(SymId::accidentalSharp, xo + 3.0 * sspread, lines[3]);
        // fall through
    }
    case 3: {
        addLayout(SymId::accidentalSharp, xo + 2.0 * sspread, lines[2]);
        // fall through
    }
    case 2: {
        addLayout(SymId::accidentalSharp, xo + 1.0 * sspread, lines[1]);
        // fall through
    }
    case 1: {
        addLayout(SymId::accidentalSharp, xo,                 lines[0]);
    }
    break;
    case -7: {
        addLayout(SymId::accidentalFlat, xo + 6.0 * fspread, lines[13]);
        // fall through
    }
    case -6: {
        addLayout(SymId::accidentalFlat, xo + 5.0 * fspread, lines[12]);
        // fall through
    }
    case -5: {
        addLayout(SymId::accidentalFlat, xo + 4.0 * fspread, lines[11]);
        // fall through
    }
    case -4: {
        addLayout(SymId::accidentalFlat, xo + 3.0 * fspread, lines[10]);
        // fall through
    }
    case -3: {
        addLayout(SymId::accidentalFlat, xo + 2.0 * fspread, lines[9]);
        // fall through
    }
    case -2: {
        addLayout(SymId::accidentalFlat, xo + 1.0 * fspread, lines[8]);
        // fall through
    }
    case -1: {
        addLayout(SymId::accidentalFlat, xo,                 lines[7]);
    }
    case 0: {
    }
    break;
...
void KeySig::write(XmlWriter& xml) const
{
    ...
    case KeyMode::MIXOLYDIAN: {
        xml.tag("mode", "mixolydian");
    }
    break;
    case KeyMode::AEOLIAN: {
        xml.tag("mode", "aeolian");
    }
    break;
    case KeyMode::IONIAN: {
        xml.tag("mode", "ionian");
...
SymId KeySig::convertFromOldId(int val) const
{
    ...
    switch (val) {
    case 32: {
        symId = SymId::accidentalSharp;
    }
    break;
    case 33: {
        symId = SymId::accidentalThreeQuarterTonesSharpArrowUp;
    }
    break;
    case 34: {
        symId = SymId::accidentalQuarterToneSharpArrowDown;
    }
    break;
    // case 35: // "sharp arrow both" missing in SMuFL
    case 36: {
        symId = SymId::accidentalQuarterToneSharpStein;
    }
    break;
    case 37: {
        symId = SymId::accidentalBuyukMucennebSharp;
    }
    break;
    case 38: {
        symId = SymId::accidentalKomaSharp;
    }
    break;
    case 39: {
        symId = SymId::accidentalThreeQuarterTonesSharpStein;
    }
    break;
    case 40: {
        symId = SymId::accidentalNatural;
    }
    break;
    case 41: {
        symId = SymId::accidentalQuarterToneSharpNaturalArrowUp;
    }
    break;
    case 42: {
        symId = SymId::accidentalQuarterToneFlatNaturalArrowDown;
    }
    break;
    // case 43: // "natural arrow both" missing in SMuFL
    case 44: {
        symId = SymId::accidentalFlat;
    }
    break;
    case 45: {
        symId = SymId::accidentalQuarterToneFlatArrowUp;
    }
    break;
    case 46: {
        symId = SymId::accidentalThreeQuarterTonesFlatArrowDown;
    }
    break;
    // case 47: // "flat arrow both" missing in SMuFL
    case 48: {
        symId = SymId::accidentalBakiyeFlat;
    }
    break;
    case 49: {
        symId = SymId::accidentalBuyukMucennebFlat;
    }
    break;
    case 50: {
        symId = SymId::accidentalThreeQuarterTonesFlatZimmermann;
    }
    break;
    case 51: {
        symId = SymId::accidentalQuarterToneFlatStein;
    }
    break;
    // case 52: // "mirrored flat slash" missing in SMuFL
    case 53: {
        symId = SymId::accidentalDoubleFlat;
    }
    break;
    // case 54: // "flat flat slash" missing in SMuFL
    case 55: {
        symId = SymId::accidentalDoubleSharp;
    }
    break;
    case 56: {
        symId = SymId::accidentalSori;
    }
    break;
    case 57: {
        symId = SymId::accidentalKoron;
    }
    break;
    default: {
