...
Element* Element::create(ElementType type, Score* score)
{
    ...
    case ElementType::VOLTA: {
        return new Volta(score);
    }
    case ElementType::OTTAVA: {
        return new Ottava(score);
    }
    case ElementType::TEXTLINE: {
        return new TextLine(score);
    }
    case ElementType::NOTELINE: {
        return new NoteLine(score);
    }
    case ElementType::TRILL: {
        return new Trill(score);
    }
    case ElementType::LET_RING: {
        return new LetRing(score);
    }
    case ElementType::VIBRATO: {
        return new Vibrato(score);
    }
    case ElementType::PALM_MUTE: {
        return new PalmMute(score);
    }
    case ElementType::PEDAL: {
        return new Pedal(score);
    }
    case ElementType::HAIRPIN: {
        return new Hairpin(score);
    }
    case ElementType::CLEF: {
        return new Clef(score);
    }
    case ElementType::KEYSIG: {
        return new KeySig(score);
    }
    case ElementType::TIMESIG: {
        return new TimeSig(score);
    }
    case ElementType::BAR_LINE: {
        return new BarLine(score);
    }
    case ElementType::SYSTEM_DIVIDER: {
        return new SystemDivider(score);
    }
    case ElementType::ARPEGGIO: {
        return new Arpeggio(score);
    }
    case ElementType::BREATH: {
        return new Breath(score);
    }
    case ElementType::GLISSANDO: {
        return new Glissando(score);
    }
    case ElementType::BRACKET: {
        return new Bracket(score);
    }
    case ElementType::ARTICULATION: {
        return new Articulation(score);
    }
    case ElementType::FERMATA: {
        return new Fermata(score);
    }
    case ElementType::CHORDLINE: {
        return new ChordLine(score);
    }
    case ElementType::ACCIDENTAL: {
        return new Accidental(score);
    }
    case ElementType::DYNAMIC: {
        return new Dynamic(score);
    }
    case ElementType::TEXT: {
        return new Text(score);
    }
    case ElementType::MEASURE_NUMBER: {
        return new MeasureNumber(score);
    }
    case ElementType::INSTRUMENT_NAME: {
        return new InstrumentName(score);
    }
    case ElementType::STAFF_TEXT: {
        return new StaffText(score);
    }
    case ElementType::SYSTEM_TEXT: {
        return new SystemText(score);
    }
    case ElementType::REHEARSAL_MARK: {
        return new RehearsalMark(score);
    }
    case ElementType::INSTRUMENT_CHANGE: {
        return new InstrumentChange(score);
    }
    case ElementType::STAFFTYPE_CHANGE: {
        return new StaffTypeChange(score);
    }
    case ElementType::NOTEHEAD: {
        return new NoteHead(score);
    }
    case ElementType::NOTEDOT: {
        return new NoteDot(score);
    }
    case ElementType::TREMOLO: {
        return new Tremolo(score);
    }
    case ElementType::LAYOUT_BREAK: {
        return new LayoutBreak(score);
    }
    case ElementType::MARKER: {
        return new Marker(score);
    }
    case ElementType::JUMP: {
        return new Jump(score);
    }
    case ElementType::REPEAT_MEASURE: {
        return new RepeatMeasure(score);
    }
    case ElementType::ICON: {
        return new Icon(score);
    }
    case ElementType::NOTE: {
        return new Note(score);
    }
    case ElementType::SYMBOL: {
        return new Symbol(score);
    }
    case ElementType::FSYMBOL: {
        return new FSymbol(score);
    }
    case ElementType::CHORD: {
        return new Chord(score);
    }
    case ElementType::REST: {
        return new Rest(score);
    }
    case ElementType::SPACER: {
        return new Spacer(score);
    }
    case ElementType::STAFF_STATE: {
        return new StaffState(score);
    }
    case ElementType::TEMPO_TEXT: {
        return new TempoText(score);
    }
    case ElementType::HARMONY: {
        return new Harmony(score);
    }
    case ElementType::FRET_DIAGRAM: {
        return new FretDiagram(score);
    }
    case ElementType::BEND: {
        return new Bend(score);
    }
    case ElementType::TREMOLOBAR: {
        return new TremoloBar(score);
    }
    case ElementType::LYRICS: {
        return new Lyrics(score);
    }
    case ElementType::FIGURED_BASS: {
        return new FiguredBass(score);
    }
    case ElementType::STEM: {
        return new Stem(score);
    }
    case ElementType::SLUR: {
        return new Slur(score);
    }
    case ElementType::TIE: {
        return new Tie(score);
    }
    case ElementType::FINGERING: {
        return new Fingering(score);
    }
    case ElementType::HBOX: {
        return new HBox(score);
    }
    case ElementType::VBOX: {
        return new VBox(score);
    }
    case ElementType::TBOX: {
        return new TBox(score);
    }
    case ElementType::FBOX: {
        return new FBox(score);
    }
    case ElementType::MEASURE: {
        return new Measure(score);
    }
    case ElementType::TAB_DURATION_SYMBOL: {
        return new TabDurationSymbol(score);
    }
    case ElementType::OSSIA: {
        return new Ossia(score);
    }
    case ElementType::IMAGE: {
        return new Image(score);
    }
    case ElementType::BAGPIPE_EMBELLISHMENT: {
        return new BagpipeEmbellishment(score);
    }
    case ElementType::AMBITUS: {
        return new Ambitus(score);
    }
    case ElementType::STICKING: {
        return new Sticking(score);
    }
