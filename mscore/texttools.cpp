    ...
    QDockWidget(parent)
{
    ...
    tb->setIconSize(QSize(preferences.getInt(PREF_UI_THEME_ICONWIDTH) * guiScaling,
...
void TextTools::superscriptClicked(bool val)
{
    ...
    cursor->setFormat(FormatId::Valign,
                      int(val ? VerticalAlignment::AlignSuperScript : VerticalAlignment::AlignNormal));
