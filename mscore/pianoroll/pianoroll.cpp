    ...
    QMainWindow(parent)
{
    ...
    ToolIconData _iconDataTool[] = {
        ...
        { QStringLiteral(":/data/icons/preEdit-insertNote.svg"), PianoRollEditTool::INSERT_NOTE, tr("Insert Note"),
          false },
        { QStringLiteral(":/data/icons/preEdit-appendChord.svg"), PianoRollEditTool::APPEND_NOTE, tr(
              "Append Note to Chord"), false },
        ...
        { QStringLiteral(":/data/icons/preEdit-changeLength.svg"), PianoRollEditTool::CHANGE_LENGTH, tr(
              "Change Chord Length"), false },
