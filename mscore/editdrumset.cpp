    ...
    QDialog(parent)
{
    ...
    QStringList validNoteheadRanges
        = { "Noteheads", "Round and square noteheads", "Slash noteheads", "Shape note noteheads",
            "Shape note noteheads supplement" };
    QSet<QString> excludeSym
        = { "noteheadParenthesisLeft", "noteheadParenthesisRight", "noteheadParenthesis", "noteheadNull" };
...
void EditDrumset::fillCustomNoteheadsDataFromComboboxes(int pitch)
{
    ...
    nDrumset.drum(pitch).noteheads[int(NoteHead::Type::HEAD_QUARTER)] = Sym::name2id(
        quarterCmb->currentData().toString());
    nDrumset.drum(pitch).noteheads[int(NoteHead::Type::HEAD_HALF)] = Sym::name2id(halfCmb->currentData().toString());
    nDrumset.drum(pitch).noteheads[int(NoteHead::Type::HEAD_BREVIS)] = Sym::name2id(
        doubleWholeCmb->currentData().toString());
}

void EditDrumset::fillNoteheadsComboboxes(bool customGroup, int pitch)
{
    if (customGroup) {
        wholeCmb->setCurrentIndex(quarterCmb->findData(Sym::id2name(nDrumset.noteHeads(pitch,
                                                                                       NoteHead::Type::HEAD_WHOLE))));
        halfCmb->setCurrentIndex(quarterCmb->findData(Sym::id2name(nDrumset.noteHeads(pitch,
                                                                                      NoteHead::Type::HEAD_HALF))));
        quarterCmb->setCurrentIndex(quarterCmb->findData(Sym::id2name(nDrumset.noteHeads(pitch,
                                                                                         NoteHead::Type::HEAD_QUARTER))));
        doubleWholeCmb->setCurrentIndex(quarterCmb->findData(Sym::id2name(nDrumset.noteHeads(pitch,
        ...
        wholeCmb->setCurrentIndex(quarterCmb->findData(Sym::id2name(Note::noteHead(0, group,
                                                                                   NoteHead::Type::HEAD_WHOLE))));
        halfCmb->setCurrentIndex(quarterCmb->findData(Sym::id2name(Note::noteHead(0, group,
                                                                                  NoteHead::Type::HEAD_HALF))));
        quarterCmb->setCurrentIndex(quarterCmb->findData(Sym::id2name(Note::noteHead(0, group,
                                                                                     NoteHead::Type::HEAD_QUARTER))));
        doubleWholeCmb->setCurrentIndex(quarterCmb->findData(Sym::id2name(Note::noteHead(0, group,
                                                                                         NoteHead::Type::HEAD_BREVIS))));
    }
}
