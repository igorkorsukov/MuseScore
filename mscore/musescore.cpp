...
bool MuseScore::processMidiRemote(MidiRemoteType type, int dta, int value)
{
    ...
    for (int i = 0; i < MIDI_REMOTES; ++i) {
        if (preferences.midiRemote(i).type == type && preferences.midiRemote(i).data == dta) {
            ...
            break;
            case RMIDI_NOTE1: {
                a = getAction("pad-note-1");
            }
            break;
            case RMIDI_NOTE2: {
                a = getAction("pad-note-2");
            }
            break;
            case RMIDI_NOTE4: {
                a = getAction("pad-note-4");
            }
            break;
            case RMIDI_NOTE8: {
                a = getAction("pad-note-8");
            }
            break;
            case RMIDI_NOTE16: {
                a = getAction("pad-note-16");
            }
            break;
            case RMIDI_NOTE32: {
                a = getAction("pad-note-32");
            }
            break;
            case RMIDI_NOTE64: {
                a = getAction("pad-note-64");
            }
            break;
            case RMIDI_REST: {
                a = getAction("rest");
            ...
            break;
            case RMIDI_NOTE_EDIT_MODE: {
                a = getAction("note-input");
            }
            break;
            case RMIDI_REALTIME_ADVANCE: {
                a = getAction("realtime-advance");
            }
            break;
            }
            if (a) {
...
const char* stateName(ScoreState s)
{
    ...
    case STATE_NOTE_ENTRY_METHOD_STEPTIME: {
        return "STATE_NOTE_ENTRY_METHOD_STEPTIME";
    }
    case STATE_NOTE_ENTRY_METHOD_REPITCH: {
        return "STATE_NOTE_ENTRY_METHOD_REPITCH";
    }
    case STATE_NOTE_ENTRY_METHOD_RHYTHM: {
        return "STATE_NOTE_ENTRY_METHOD_RHYTHM";
    }
    case STATE_NOTE_ENTRY_METHOD_REALTIME_AUTO: {
        return "STATE_NOTE_ENTRY_METHOD_REALTIME_AUTO";
    }
    case STATE_NOTE_ENTRY_METHOD_REALTIME_MANUAL: {
        return "STATE_NOTE_ENTRY_METHOD_REALTIME_MANUAL";
    }
    case STATE_EDIT: {
        return "STATE_EDIT";
    }
