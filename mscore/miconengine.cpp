            ...
            if (mode == QIcon::Disabled) {
                if (Ms::preferences.isThemeDark()) {
                    if (state == QIcon::On) {
                        ...
                        ba.replace("#3b3f45", colorName).replace("#3B3F45", colorName).replace("rgb(59,63,69)",
                                                                                               colorName);
                    } else {
                        auto colorName
                    ...
                    if (state == QIcon::On) {
                        ...
                        auto colorName
                            = Ms::preferences.getColor(PREF_UI_BUTTON_HIGHLIGHT_COLOR_DISABLED_LIGHT_OFF).name().
                              toLatin1();
                        ba.replace("#3b3f45", colorName).replace("#3B3F45", colorName).replace("rgb(59,63,69)",
                                                                                               colorName);
                    }
                ...
                if (Ms::preferences.isThemeDark()) {
                    if (state == QIcon::On) {
                        auto colorName
                            = Ms::preferences.getColor(PREF_UI_BUTTON_HIGHLIGHT_COLOR_ENABLED_DARK_ON).name().toLatin1();
                        ba.replace("#3b3f45", colorName).replace("#3B3F45", colorName).replace("rgb(59,63,69)",
                                                                                               colorName);
                    } else {
                        auto colorName
