...
class TextSettingsModel : public AbstractInspectorModel
{
    ...
    Q_PROPERTY(mu::inspector::PropertyItem * textLineSpacing READ textLineSpacing CONSTANT)
    Q_PROPERTY(mu::inspector::PropertyItem * horizontalAlignment READ horizontalAlignment CONSTANT)
    Q_PROPERTY(mu::inspector::PropertyItem * verticalAlignment READ verticalAlignment CONSTANT)
    ...
    Q_PROPERTY(mu::inspector::PropertyItem * textScriptAlignment READ textScriptAlignment CONSTANT)
