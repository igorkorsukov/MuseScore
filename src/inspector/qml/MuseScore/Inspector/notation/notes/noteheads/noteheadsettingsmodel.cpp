...
NoteheadSettingsModel::NoteheadSettingsModel(QObject* parent,
...
void NoteheadSettingsModel::createProperties()
{
    ...
    m_hasHeadParentheses
        = buildPropertyItem(mu::engraving::Pid::HAS_PARENTHESES,
                            [&](const mu::engraving::Pid, const QVariant& hasParens) {
        ...
        beginCommand(TranslatableString("undoableAction",
                                        "Reset %1").arg(propertyUserName(propertyId)));
...
void NoteheadSettingsModel::onNotationChanged(
    const mu::engraving::PropertyIdSet& changedPropertyIdSet, const mu::engraving::StyleIdSet&)
{
...
QVariantList NoteheadSettingsModel::possibleHeadSystemTypes() const
{
    QMap<mu::engraving::NoteHeadScheme, QString> types {
        { mu::engraving::NoteHeadScheme::HEAD_AUTO,                    muse::qtrc("inspector",
                                                                                  "Auto",
                                                                                  "notehead scheme") },
        { mu::engraving::NoteHeadScheme::HEAD_NORMAL,                  muse::qtrc("inspector",
                                                                                  "Normal",
                                                                                  "notehead scheme") },
        { mu::engraving::NoteHeadScheme::HEAD_PITCHNAME,               muse::qtrc("inspector",
                                                                                  "Pitch names",
                                                                                  "notehead scheme") },
        { mu::engraving::NoteHeadScheme::HEAD_PITCHNAME_GERMAN,        muse::qtrc("inspector",
                                                                                  "German pitch names",
                                                                                  "notehead scheme") },
        { mu::engraving::NoteHeadScheme::HEAD_SOLFEGE,                 muse::qtrc("inspector",
                                                                                  "Solfège movable do",
                                                                                  "notehead scheme") },
        { mu::engraving::NoteHeadScheme::HEAD_SOLFEGE_FIXED,           muse::qtrc("inspector",
                                                                                  "Solfège fixed do",
                                                                                  "notehead scheme") },
        { mu::engraving::NoteHeadScheme::HEAD_SHAPE_NOTE_4,            muse::qtrc("inspector",
                                                                                  "4-shape (Walker)",
                                                                                  "notehead scheme") },
        { mu::engraving::NoteHeadScheme::HEAD_SHAPE_NOTE_7_AIKIN,      muse::qtrc("inspector",
                                                                                  "7-shape (Aikin)",
                                                                                  "notehead scheme") },
        { mu::engraving::NoteHeadScheme::HEAD_SHAPE_NOTE_7_FUNK,       muse::qtrc("inspector",
                                                                                  "7-shape (Funk)",
                                                                                  "notehead scheme") },
        { mu::engraving::NoteHeadScheme::HEAD_SHAPE_NOTE_7_WALKER,     muse::qtrc("inspector",
                                                                                  "7-shape (Walker)",
                                                                                  "notehead scheme") },
    };
