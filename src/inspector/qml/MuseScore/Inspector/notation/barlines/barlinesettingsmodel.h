...
class BarlineSettingsModel : public AbstractInspectorModel
{
    ...
    Q_PROPERTY(mu::inspector::PropertyItem * playCount READ playCount CONSTANT)
    Q_PROPERTY(mu::inspector::PropertyItem * playCountText READ playCountText CONSTANT)
    Q_PROPERTY(mu::inspector::PropertyItem
               * playCountTextSetting READ playCountTextSetting CONSTANT)
    Q_PROPERTY(mu::inspector::PropertyItem * isSpanToNextStaff READ isSpanToNextStaff CONSTANT)
    ...
    Q_PROPERTY(
        bool showPlayCountSettings READ showPlayCountSettings NOTIFY showPlayCountSettingsChanged FINAL)
