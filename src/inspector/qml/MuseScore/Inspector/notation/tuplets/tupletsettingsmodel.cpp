...
TupletSettingsModel::TupletSettingsModel(QObject* parent,
...
QVariantList TupletSettingsModel::possibleBracketTypes() const
{
    ...
    QVariantList types {
        ...
        object(Type::SHOW_BRACKET, muse::qtrc("inspector", "Bracket",
                                              "tuplet bracket type"),
               Icon::TUPLET_NUMBER_WITH_BRACKETS),
        object(Type::SHOW_NO_BRACKET, muse::qtrc("inspector", "None",
                                                 "tuplet bracket type"), Icon::TUPLET_NUMBER_ONLY)
    };
