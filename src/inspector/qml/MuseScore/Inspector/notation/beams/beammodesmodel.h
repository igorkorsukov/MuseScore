...
class BeamModesModel : public AbstractInspectorModel
{
    ...
    Q_PROPERTY(
        mu::inspector::PropertyItem * isFeatheringAvailable READ isFeatheringAvailable CONSTANT)

public:
    explicit BeamModesModel(QObject* parent, const muse::modularity::ContextPtr& iocCtx,
