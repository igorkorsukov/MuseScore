...
void PedalSettingsModel::updateStartAndEndHookTypes()
{
    ...
    static const QList<HookTypeInfo> endHookTypes {
        { mu::engraving::HookType::NONE, IconCode::LINE_NORMAL, muse::qtrc("inspector", "Normal",
                                                                           "hook type") },
        { mu::engraving::HookType::ROSETTE, IconCode::LINE_PEDAL_STAR_ENDING, muse::qtrc(
              "inspector", "Asterisk", "hook type") },
...
void PedalSettingsModel::createProperties()
{
    ...
    m_lineType
        = buildPropertyItem(mu::engraving::Pid::END,
    ...
    connect(
        endHookType(), &PropertyItem::isModifiedChanged, m_lineType, &PropertyItem::setIsModified);
