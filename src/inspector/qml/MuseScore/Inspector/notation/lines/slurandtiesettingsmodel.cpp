...
SlurAndTieSettingsModel::SlurAndTieSettingsModel(QObject* parent,
...
{
    QVariantList result {
        object(SlurStyleType::Solid, muse::qtrc("inspector", "Normal",
                                                "slur style"), IconCode::LINE_NORMAL),
        object(SlurStyleType::WideDashed, muse::qtrc("inspector", "Wide dashed",
                                                     "slur style"), IconCode::LINE_WIDE_DASHED),
        object(SlurStyleType::Dashed, muse::qtrc("inspector", "Dashed",
                                                 "slur style"), IconCode::LINE_DASHED),
        object(SlurStyleType::Dotted, muse::qtrc("inspector", "Dotted",
                                                 "slur style"), IconCode::LINE_DOTTED)
    };
