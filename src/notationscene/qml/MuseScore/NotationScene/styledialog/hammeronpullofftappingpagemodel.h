...
class HammerOnPullOffTappingPageModel : public AbstractStyleDialogModel
{
    ...
    Q_PROPERTY(mu::notation::StyleItem * showOnStandardStaves READ showOnStandardStaves CONSTANT)
    Q_PROPERTY(mu::notation::StyleItem * showOnTabStaves READ showOnTabStaves CONSTANT)
