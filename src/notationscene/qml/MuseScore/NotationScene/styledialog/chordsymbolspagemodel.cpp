...
StyleItem* ChordSymbolsPageModel::chordStylePreset() const
{
    return styleItem(StyleId::chordStyle);
}
StyleItem* ChordSymbolsPageModel::chordDescriptionFile() const
{
    return styleItem(StyleId::chordDescriptionFile);
}
...
void ChordSymbolsPageModel::selectChordDescriptionFile()
{
    ...
    std::vector<std::string> filter
        = { muse::trc("notation", "MuseScore chord symbol style files") + " (*.xml)" };

    muse::io::path_t path = interactive()->selectOpeningFileSync(muse::trc("notation",
                                                                           "Load style"), dir,
                                                                 filter);
    if (path.empty()) {
        return;
...
StyleItem* ChordSymbolsPageModel::extensionMag() const
{
    return styleItem(StyleId::chordExtensionMag);
}
StyleItem* ChordSymbolsPageModel::extensionAdjust() const
{
    return styleItem(StyleId::chordExtensionAdjust);
}

StyleItem* ChordSymbolsPageModel::modifierMag() const
{
    return styleItem(StyleId::chordModifierMag);
}
StyleItem* ChordSymbolsPageModel::modifierAdjust() const
{
    return styleItem(StyleId::chordModifierAdjust);
}
...
StyleItem* ChordSymbolsPageModel::chordBassNoteStagger() const
{
    return styleItem(StyleId::chordBassNoteStagger);
}
StyleItem* ChordSymbolsPageModel::chordBassNoteScale() const
{
    return styleItem(StyleId::chordBassNoteScale);
}
...
StyleItem* ChordSymbolsPageModel::chordAlignmentToNotehead() const
{
    return styleItem(StyleId::chordSymPosition);
}
...
StyleItem* ChordSymbolsPageModel::chordSymbolSpelling() const
{
    return styleItem(StyleId::chordSymbolSpelling);
}
...
StyleItem* ChordSymbolsPageModel::lowerCaseMinorChords() const
{
    return styleItem(StyleId::lowerCaseMinorChords);
}
StyleItem* ChordSymbolsPageModel::lowerCaseBassNotes() const
{
    return styleItem(StyleId::lowerCaseBassNotes);
}
StyleItem* ChordSymbolsPageModel::allCapsNoteNames() const
{
    return styleItem(StyleId::allCapsNoteNames);
}

StyleItem* ChordSymbolsPageModel::harmonyFretDist() const
{
    return styleItem(StyleId::harmonyFretDist);
}
StyleItem* ChordSymbolsPageModel::minHarmonyDist() const
{
    return styleItem(StyleId::minHarmonyDistance);
}
StyleItem* ChordSymbolsPageModel::harmonyHarmonyDist() const
{
    return styleItem(StyleId::harmonyHarmonyDistance);
}
...
StyleItem* ChordSymbolsPageModel::harmonyVoiceLiteral() const
{
    return styleItem(StyleId::harmonyVoiceLiteral);
}
StyleItem* ChordSymbolsPageModel::harmonyVoicing() const
{
    return styleItem(StyleId::harmonyVoicing);
}
StyleItem* ChordSymbolsPageModel::harmonyDuration() const
{
    return styleItem(StyleId::harmonyDuration);
}

StyleItem* ChordSymbolsPageModel::displayCapoChords() const
{
    return styleItem(StyleId::displayCapoChords);
}
...
QVariantList ChordSymbolsPageModel::possibleCapoDisplayOptions() const
{
    QVariantList options {
        QVariantMap{
            { "text", muse::qtrc("notation/editstyle/chordsymbols",
                                 "Don’t show chord symbols transposed by capo") },
            { "value", static_cast<int>(mu::engraving::DisplayCapoChordType::CONCERT) } },
        QVariantMap{
            { "text", muse::qtrc("notation/editstyle/chordsymbols",
                                 "Show chord symbols & transposed symbols") },
            { "value", static_cast<int>(mu::engraving::DisplayCapoChordType::BOTH) } },
        QVariantMap{
            { "text",
              muse::qtrc("notation/editstyle/chordsymbols", "Show transposed symbols only") },
