...
class InstrumentNamesPageModel : public AbstractStyleDialogModel
{
    ...
    Q_PROPERTY(
        ...
        * instrumentNamesAlignLong READ instrumentNamesAlignLong CONSTANT)
    Q_PROPERTY(
        mu::notation::StyleItem
        * instrumentNamesAlignShort READ instrumentNamesAlignShort CONSTANT)
    Q_PROPERTY(
        mu::notation::StyleItem
        * instrumentNamesStackVertically READ instrumentNamesStackVertically CONSTANT)
    ...
    Q_PROPERTY(
        mu::notation::StyleItem
        * instrumentNamesShowTranspositionLong READ instrumentNamesShowTranspositionLong CONSTANT)
    Q_PROPERTY(
        mu::notation::StyleItem
        * instrumentNamesShowTranspositionShort READ instrumentNamesShowTranspositionShort CONSTANT)
    Q_PROPERTY(
        mu::notation::StyleItem
        * instrumentNamesFormatLong READ instrumentNamesFormatLong CONSTANT)
    Q_PROPERTY(
        mu::notation::StyleItem
        * instrumentNamesCustomFormatLong READ instrumentNamesCustomFormatLong CONSTANT)
    Q_PROPERTY(
        mu::notation::StyleItem
        * instrumentNamesFormatShort READ instrumentNamesFormatShort CONSTANT)
    Q_PROPERTY(
        mu::notation::StyleItem
        * instrumentNamesCustomFormatShort READ instrumentNamesCustomFormatShort CONSTANT)
    Q_PROPERTY(
        mu::notation::StyleItem
