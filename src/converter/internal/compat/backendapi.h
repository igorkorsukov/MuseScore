...
public:
    ...
    static muse::Ret updateSource(const muse::io::path_t& in, const std::string& newSource,
...
private:
    ...
    static muse::Ret exportScorePngs(const notation::INotationPtr notation,
                                     BackendJsonWriter& jsonWriter, bool addSeparator = false);
    static muse::Ret exportScoreSvgs(const notation::INotationPtr notation,
                                     const muse::io::path_t& highlightConfigPath,
                                     BackendJsonWriter& jsonWriter, bool addSeparator = false);
    static muse::Ret exportScoreElementsPositions(const std::string& elementsPositionsWriterName,
                                                  ...
                                                  const notation::INotationPtr notation,
                                                  BackendJsonWriter& jsonWriter,
                                                  bool addSeparator = false);
    static muse::Ret exportScorePdf(const notation::INotationPtr notation,
                                    BackendJsonWriter& jsonWriter, bool addSeparator = false);
    static muse::Ret exportScorePdf(const notation::INotationPtr notation,
                                    QIODevice& destinationDevice);
    static muse::Ret exportScoreMidi(const notation::INotationPtr notation,
                                     BackendJsonWriter& jsonWriter, bool addSeparator = false);
    static muse::Ret exportScoreMusicXML(const notation::INotationPtr notation,
                                         BackendJsonWriter& jsonWriter, bool addSeparator = false);
    static muse::Ret exportScoreMetaData(const notation::INotationPtr notation,
                                         BackendJsonWriter& jsonWriter, bool addSeparator = false);
    ...
    static muse::Ret doExportScoreParts(const notation::IMasterNotationPtr notation,
                                        QIODevice& destinationDevice);
    static muse::Ret doExportScorePartsPdfs(const notation::IMasterNotationPtr notation,
                                            QIODevice& destinationDevice,
                                            const std::string& scoreFileName);
    static muse::Ret doExportScoreTranspose(const notation::INotationPtr notation,
                                            BackendJsonWriter& jsonWriter,
                                            bool addSeparator = false);

    static muse::Ret doExportScoreElements(const notation::INotationPtr notation, QIODevice& out);

    static muse::RetVal<QByteArray> scorePartJson(mu::engraving::Score* score,
