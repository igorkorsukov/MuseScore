...
public:
    ...
    virtual muse::Ret setupNewScore(engraving::MasterScore* score,
                                    const ScoreCreateOptions& options) = 0;
    ...
    virtual void setMasterScore(engraving::MasterScore* masterScore,
                                bool disablePlayback = false) = 0;
