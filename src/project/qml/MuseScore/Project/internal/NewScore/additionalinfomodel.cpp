...
AdditionalInfoModel::KeySignature::KeySignature(const QString& titleMajor,
                                                const QString& titleMinor, IconCode::Code icon,
                                                Key key)
...
{
    setKeySignature(KeySignature(muse::qtrc("project/newscore", "C major"),
                                 muse::qtrc("project/newscore", "A minor"),
...
{
    QVariantList list = {
        KeySignature(muse::qtrc("project/newscore", "C major"),
                     muse::qtrc("project/newscore", "A minor"),
                     IconCode::Code::KEY_SIGNATURE_NONE, Key::C).toMap(),
        KeySignature(muse::qtrc("project/newscore", "G major"),
                     muse::qtrc("project/newscore", "E minor"),
                     IconCode::Code::KEY_SIGNATURE_1_SHARP, Key::G).toMap(),
        KeySignature(muse::qtrc("project/newscore", "D major"),
                     muse::qtrc("project/newscore", "B minor"),
                     IconCode::Code::KEY_SIGNATURE_2_SHARPS, Key::D).toMap(),
        KeySignature(muse::qtrc("project/newscore", "A major"),
                     muse::qtrc("project/newscore", "F♯ minor"),
                     IconCode::Code::KEY_SIGNATURE_3_SHARPS, Key::A).toMap(),
        KeySignature(muse::qtrc("project/newscore", "E major"),
                     muse::qtrc("project/newscore", "C♯ minor"),
                     IconCode::Code::KEY_SIGNATURE_4_SHARPS, Key::E).toMap(),
        KeySignature(muse::qtrc("project/newscore", "B major"),
                     muse::qtrc("project/newscore", "G♯ minor"),
                     IconCode::Code::KEY_SIGNATURE_5_SHARPS, Key::B).toMap(),
        KeySignature(muse::qtrc("project/newscore", "F♯ major"),
                     muse::qtrc("project/newscore", "D♯ minor"),
                     IconCode::Code::KEY_SIGNATURE_6_SHARPS, Key::F_S).toMap(),
        KeySignature(muse::qtrc("project/newscore", "C♯ major"),
                     muse::qtrc("project/newscore", "A♯ minor"),
                     IconCode::Code::KEY_SIGNATURE_7_SHARPS, Key::C_S).toMap(),
        KeySignature(muse::qtrc("project/newscore", "Open/Atonal"),
                     muse::qtrc("project/newscore", "Open/Atonal"),
...
QString AdditionalInfoModel::tempoAccessibleName(int noteIcon, bool withDot) const
{
    ...
    case MusicalSymbolCode::SEMIQUAVER:
        return withDot ? muse::qtrc("project/newscore", "Dotted 16th note") : muse::qtrc(
            "project/newscore", "16th note");
    case MusicalSymbolCode::QUAVER:
        return withDot ? muse::qtrc("project/newscore", "Dotted eighth note") : muse::qtrc(
            "project/newscore", "Eighth note");
    case MusicalSymbolCode::CROTCHET:
        return withDot ? muse::qtrc("project/newscore", "Dotted quarter note") : muse::qtrc(
            "project/newscore", "Quarter note");
    case MusicalSymbolCode::MINIM:
        return withDot ? muse::qtrc("project/newscore", "Dotted half note") : muse::qtrc(
            "project/newscore", "Half note");
    case MusicalSymbolCode::SEMIBREVE:
        return withDot ? muse::qtrc("project/newscore", "Dotted whole note") : muse::qtrc(
            "project/newscore", "Whole note");
    default:
        break;
    }
