...
class MixerPanelModel : public QAbstractListModel, public QQmlParserStatus,
    public muse::async::Asyncable, public muse::Contextable
{
    ...
    Q_PROPERTY(
        int navigationOrderStart READ navigationOrderStart WRITE setNavigationOrderStart NOTIFY navigationOrderStartChanged)
...
private:
    ...
    MixerChannelItem* buildAuxChannelItem(muse::audio::aux_channel_idx_t index,
