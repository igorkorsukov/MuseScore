...
class AbstractCloudService : public QObject, public IAuthorizationService, public muse::Injectable, public async::Asyncable
{
    Q_OBJECT
public:
...
public:
    explicit AbstractCloudService(const muse::modularity::ContextPtr& iocCtx, QObject* parent = nullptr);
