...
class IDiagnosticDrawProvider : MODULE_GLOBAL_INTERFACE
{
    INTERFACE_ID(IDiagnosticDrawProvider)
public:
    virtual ~IDiagnosticDrawProvider() = default;

    virtual muse::Ret generateDrawData(const muse::io::path_t& scoresDir,
                                       const muse::io::path_t& outDir,
    ...
    virtual muse::Ret drawDataToPng(const muse::io::path_t& dataFile,
                                    const muse::io::path_t& outFile) = 0;
    virtual muse::Ret drawDiffToPng(const muse::io::path_t& diffFile,
