...
PlaybackSetupData VoicesSetupDataResolver::doResolve(const Instrument* instrument)
{
    static const std::unordered_map<std::string, mpe::PlaybackSetupData> SETUP_DATA_MAP = {
        ...
        { "soprano-c-clef",
          { SoundId::Choir, SoundCategory::Voices, { SoundSubCategory::Soprano } } },
        { "mezzo-soprano",
          { SoundId::Choir, SoundCategory::Voices, { SoundSubCategory::Soprano } } },
        { "mezzo-soprano-c-clef",
          { SoundId::Choir, SoundCategory::Voices, { SoundSubCategory::Soprano } } },
        { "countertenor",
          { SoundId::Choir, SoundCategory::Voices, { SoundSubCategory::Counter_Tenor } } },
        ...
        { "contralto",
          { SoundId::Choir, SoundCategory::Voices, { SoundSubCategory::Contra_Alto } } },
        ...
        { "baritone-c-clef",
          { SoundId::Choir, SoundCategory::Voices, { SoundSubCategory::Baritone } } },
