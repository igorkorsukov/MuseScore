...
class EngravingUndoStackModel : public QAbstractItemModel, public muse::async::Asyncable,
...
private:
    ...
    Item* createItem(Item* parent, const engraving::UndoCommand* undoCommand,
