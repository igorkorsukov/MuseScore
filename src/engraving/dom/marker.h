...
public:
    ...
    inline bool isSegno() const
    {
        return m_markerType == MarkerType::SEGNO || m_markerType == MarkerType::VARSEGNO;
    }
    ...
    inline bool isRightMarker() const
    {
        return muse::contains(Marker::RIGHT_MARKERS, m_markerType);
    }
