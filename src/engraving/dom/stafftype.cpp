...
StaffType::StaffType(const Color& defaultColor)
{
...
void StaffType::drawInputStringMarks(Painter* p, int string, voice_idx_t voice, const Color& selectionColor, const RectF& rect) const
{
    UNUSED(voice);
