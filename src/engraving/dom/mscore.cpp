...
std::string MScore::errorToString(MsError err)
{
    ...
    case MsError::CANNOT_CHANGE_LOCAL_TIMESIG_MEASURE_NOT_EMPTY: return
            "CANNOT_CHANGE_LOCAL_TIMESIG_MEASURE_NOT_EMPTY";
    case MsError::CANNOT_CHANGE_LOCAL_TIMESIG_HAS_EXCERPTS: return
    ...
    case MsError::CANNOT_JOIN_MEASURE_STAFFTYPE_CHANGE: return
    ...
    case MsError::CANNOT_EXPLODE_IMPLODE_LOCAL_TIMESIG: return
