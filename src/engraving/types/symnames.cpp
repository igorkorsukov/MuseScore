...
const std::array<muse::TranslatableString, size_t(SymId::lastSym) + 1> SymNames::s_symUserNames { {
    ...
    muse::TranslatableString("engraving/sym", "Tempus perfectum cum prolatione perfecta (9/8)"),
    muse::TranslatableString("engraving/sym",
                             "Tempus imperfectum cum prolatione imperfecta diminution 4"),
    muse::TranslatableString("engraving/sym",
                             "Tempus imperfectum cum prolatione imperfecta diminution 5"),
    muse::TranslatableString("engraving/sym", "Tempus perfectum cum prolatione imperfecta (3/4)"),
    muse::TranslatableString("engraving/sym",
                             "Tempus perfectum cum prolatione imperfecta diminution 1 (3/8)"),
    muse::TranslatableString("engraving/sym",
                             "Tempus perfectum cum prolatione perfecta diminution 2 (9/16)"),
    muse::TranslatableString("engraving/sym", "Tempus imperfectum cum prolatione perfecta (6/8)"),
    muse::TranslatableString("engraving/sym", "Tempus imperfectum cum prolatione imperfecta (2/4)"),
    muse::TranslatableString("engraving/sym",
    ...
    muse::TranslatableString::untranslatable(
        "Left parenthesis for whole time signature (outside staff)"),
    muse::TranslatableString::untranslatable(
        "Left parenthesis for whole time signature (large, narrow)"),
    muse::TranslatableString::untranslatable(
        "Right parenthesis for whole time signature (outside staff)"),
    muse::TranslatableString::untranslatable(
        "Right parenthesis for whole time signature (large, narrow)"),
