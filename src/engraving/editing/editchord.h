...
public:
    ...
    static void removeChordParentheses(Chord* chord, std::vector<Note*> notes,
                                       bool addToLinked = true, bool generated = false);
...
private:
    ...
    static void undoAddParenthesesToNotes(Chord* chord, std::vector<Note*> notes,
                                          bool addToLinked = true, bool generated = false);
    static void undoRemoveParenthesesFromNote(Chord* chord, Note* note, Parenthesis* leftParen,
                                              bool removeFromLinked = true);
    static void undoClearParenthesisGroup(Chord* chord, std::vector<Note*> notes,
