...
public:
    ...
    static void setInstrumentName(Score* score, Part* part, const Fraction& tick,
                                  const String& name);
    static void setInstrumentAbbreviature(Score* score, Part* part, const Fraction& tick,
                                          const String& abbreviature);
    static void setInstrumentGroupNameOptions(Score* score, Part* part, const Fraction& tick,
    ...
    static void moveParts(Score* score, const std::vector<Part*>& sourceParts,
                          Part* destinationPart, bool insertAfter);
    static void moveStaves(Score* score, const std::vector<Staff*>& sourceStaves,
    ...
    static void replaceDrumset(Score* score, Part* part, const Fraction& tick,
...
private:
    static void doAppendStaff(Score* score, Staff* staff, Part* destinationPart,
