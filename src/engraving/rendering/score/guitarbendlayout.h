...
private:
    ...
    static void adjustX(GuitarBendSegment* item, PointF& startPos, PointF& endPos,
    ...
    static PointF computeStartPos(GuitarBendSegment* item, Note* startNote, double distAboveTab,
                                  double verticalPad, double arrowHeight);
    static PointF computeEndPos(GuitarBendSegment* item, Note* endNote, double distAboveTab,
                                double verticalPad, double arrowHeight, double arrowWidth,
                                const PointF& startPos, const PointF& prevEndPoint);
