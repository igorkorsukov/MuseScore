...
class ImportPreferencesModel : public QObject, public muse::Contextable,
    public muse::async::Asyncable
{
    ...
    Q_PROPERTY(
        bool inferTextType READ inferTextType WRITE setInferTextType NOTIFY inferTextTypeChanged)

    Q_PROPERTY(
        bool meiImportLayout READ meiImportLayout WRITE setMeiImportLayout NOTIFY meiImportLayoutChanged)
