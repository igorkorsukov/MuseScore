...
static constexpr UnicodeRange unicodeRanges[] = {
    ...
    { 0x1400, 0x167F, QT_TRANSLATE_NOOP("palette/unicodeRanges",
    ...
    { 0x18B0, 0x18FF, QT_TRANSLATE_NOOP("palette/unicodeRanges",
    ...
    { 0x1AB0, 0x1AFF, QT_TRANSLATE_NOOP("palette/unicodeRanges",
    ...
    { 0x1D80, 0x1DBF,
      QT_TRANSLATE_NOOP("palette/unicodeRanges", "Phonetic Extensions Supplement") },
    { 0x1DC0, 0x1DFF, QT_TRANSLATE_NOOP("palette/unicodeRanges",
    ...
    { 0x20D0, 0x20FF, QT_TRANSLATE_NOOP("palette/unicodeRanges",
    ...
    { 0x27C0, 0x27EF, QT_TRANSLATE_NOOP("palette/unicodeRanges",
    ...
    { 0x2980, 0x29FF, QT_TRANSLATE_NOOP("palette/unicodeRanges",
                                        "Miscellaneous Mathematical Symbols-B") },
    { 0x2A00, 0x2AFF, QT_TRANSLATE_NOOP("palette/unicodeRanges",
                                        "Supplemental Mathematical Operators") },
    { 0x2B00, 0x2BFF,
      QT_TRANSLATE_NOOP("palette/unicodeRanges", "Miscellaneous Symbols and Arrows") },
    ...
    { 0x2FF0, 0x2FFF, QT_TRANSLATE_NOOP("palette/unicodeRanges",
    ...
    { 0x3200, 0x32FF,
      QT_TRANSLATE_NOOP("palette/unicodeRanges", "Enclosed CJK Letters and Months") },
    { 0x3300, 0x33FF, QT_TRANSLATE_NOOP("palette/unicodeRanges", "CJK Compatibility") },
    { 0x3400, 0x4DB5, QT_TRANSLATE_NOOP("palette/unicodeRanges",
    ...
    { 0x12400, 0x1247F, QT_TRANSLATE_NOOP("palette/unicodeRanges",
    ...
    { 0x13430, 0x1343F, QT_TRANSLATE_NOOP("palette/unicodeRanges",
    ...
    { 0x16FE0, 0x16FFF, QT_TRANSLATE_NOOP("palette/unicodeRanges",
    ...
    { 0x1D200, 0x1D24F,
      QT_TRANSLATE_NOOP("palette/unicodeRanges", "Ancient Greek Musical Notation") },
    ...
    { 0x1D400, 0x1D7FF, QT_TRANSLATE_NOOP("palette/unicodeRanges",
    ...
    { 0x1EE00, 0x1EEFF, QT_TRANSLATE_NOOP("palette/unicodeRanges",
    ...
    { 0x1F100, 0x1F1FF, QT_TRANSLATE_NOOP("palette/unicodeRanges",
                                          "Enclosed Alphanumeric Supplement") },
    { 0x1F200, 0x1F2FF,
      QT_TRANSLATE_NOOP("palette/unicodeRanges", "Enclosed Ideographic Supplement") },
    { 0x1F300, 0x1F5FF, QT_TRANSLATE_NOOP("palette/unicodeRanges",
    ...
    { 0x1F900, 0x1F9FF, QT_TRANSLATE_NOOP("palette/unicodeRanges",
                                          "Supplemental Symbols and Pictographs") },
    { 0x1FA00, 0x1FA6F, QT_TRANSLATE_NOOP("palette/unicodeRanges", "Chess Symbols") },
    { 0x1FA70, 0x1FAFF, QT_TRANSLATE_NOOP("palette/unicodeRanges",
                                          "Symbols and Pictographs Extended-A") },
    { 0x1FB00, 0x1FBFF,
      QT_TRANSLATE_NOOP("palette/unicodeRanges", "Symbols for Legacy Computing") },
    { 0x20000, 0x2A6D6, QT_TRANSLATE_NOOP("palette/unicodeRanges",
                                          "CJK Unified Ideographs Extension B") },
    { 0x2A700, 0x2B734, QT_TRANSLATE_NOOP("palette/unicodeRanges",
                                          "CJK Unified Ideographs Extension C") },
    { 0x2B740, 0x2B81D, QT_TRANSLATE_NOOP("palette/unicodeRanges",
                                          "CJK Unified Ideographs Extension D") },
    { 0x2F800, 0x2F81D, QT_TRANSLATE_NOOP("palette/unicodeRanges",
                                          "CJK Compatibility Ideographs Supplement") },
    { 0xE0001, 0xE007F, QT_TRANSLATE_NOOP("palette/unicodeRanges", "Tags") },
    { 0xE0100, 0xE01EF,
      QT_TRANSLATE_NOOP("palette/unicodeRanges", "Variation Selectors Supplement") },
    { 0xF0000, 0xFFFFD, QT_TRANSLATE_NOOP("palette/unicodeRanges",
                                          "Supplementary Private Use Area-A") },
    { 0x100000, 0x10FFFD, QT_TRANSLATE_NOOP("palette/unicodeRanges",
    ...
    : TopLevelDialog(parent)
{
    ...
    for (const UnicodeRange& range : unicodeRanges) {
        QListWidgetItem* newItem
            = new QListWidgetItem(muse::qtrc("palette/unicodeRanges", range.name));
    ...
    connect(m_lwu, &QListWidget::currentRowChanged, this,
            &SpecialCharactersDialog::populateUnicode);
}
...
void SpecialCharactersDialog::populateUnicode()
{
    ...
    for (char32_t code = range.first; code <= range.last; ++code) {
        ...
        fs->setCode(code);
        fs->setFont(m_font);
        m_pUnicode->appendElement(fs,
                                  QString("0x%1").arg(static_cast<int>(code), 5, 16,
                                                      QLatin1Char('0')));
    }
}
