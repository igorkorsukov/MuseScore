...
{
public:
    MScoreTextToMusicXml(const muse::String& tag, const muse::String& attr,
                         const engraving::CharFormat& defFmt, const muse::String& mtf);
    ...
    static bool split(const std::list<engraving::TextFragment>& in, const int pos, const int len,
                      std::list<engraving::TextFragment>& left,
                      std::list<engraving::TextFragment>& mid,
                      std::list<engraving::TextFragment>& right);
    void writeTextFragments(const std::list<engraving::TextFragment>& fr,
                            engraving::XmlWriter& xml);
