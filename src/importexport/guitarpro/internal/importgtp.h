...
mu::engraving::Err importGTP(mu::engraving::Score* score, const muse::String& filename,
...
protected:
    ...
    void createMeasures();
    void applyBeatEffects(mu::engraving::Chord*, int beatEffects, bool& hasVibratoLeftHand,
                          bool& hasVibratoWTremBar);
    void readTremoloBar(int track, mu::engraving::Segment*);
    void readChord(mu::engraving::Segment* seg, int track, int numStrings, muse::String name,
                   bool gpHeader);
    void restsForEmptyBeats(mu::engraving::Segment* seg, Measure* measure, ChordRest* cr,
                            Fraction& l, int track, const Fraction& tick);
    ...
    void addHarmonicMarks(ChordRest* cr, bool hasHarmonicArtificial, bool hasHarmonicPinch,
                          bool hasHarmonicTap, bool hasHarmonicSemi);
    void addTap(Chord*);
    void addSlap(Note*);
    void addPop(Note*);
...
class GuitarPro5 : public GuitarPro
{
    ...
    Fraction readBeat(const Fraction& tick, int voice, Measure* measure, int staffIdx,
                      mu::engraving::Tuplet** tuplets, bool mixChange);
