...
public:
     ...
     */
    void buildContiniousElement(mu::engraving::ChordRest* cr, mu::engraving::ElementType muType,
                                ImportType importType, bool elemExists, sub_type_t subType = 0);
...
private:
    ...
    ContiniousElementState calculateState(bool isRest, bool elemExists, bool splitByRests,
    ...
    std::unordered_map<mu::engraving::ElementType,
                       std::unordered_map<track_idx_t, std::unordered_map<sub_type_t,
                                                                          ImportType> > >
    m_lastImportTypes;
    std::unordered_map<track_idx_t, std::unordered_map<ImportType,
                                                       std::set<mu::engraving::Spanner*> > >
    m_spannersWithoutEndElement;
    std::unordered_map<track_idx_t,
                       std::unordered_map<ImportType, ContiniousElement> > m_elementsToAddToScore;
