...
static const Settings::Key EXPORT_PDF_USE_TRANSPARENCY_KEY("iex_imagesexport",
                                                           "export/pdf/useTransparency");
static const Settings::Key EXPORT_PDF_USE_GRAYSCALE_KEY("iex_imagesexport",
                                                        "export/pdf/useGrayscale");
static const Settings::Key EXPORT_PNG_DPI_RESOLUTION_KEY("iex_imagesexport",
                                                         "export/png/resolution");
static const Settings::Key EXPORT_PNG_USE_TRANSPARENCY_KEY("iex_imagesexport",
                                                           "export/png/useTransparency");
static const Settings::Key EXPORT_PNG_USE_GRAYSCALE_KEY("iex_imagesexport",
                                                        "export/png/useGrayscale");
static const Settings::Key EXPORT_SVG_USE_TRANSPARENCY_KEY("iex_imagesexport",
                                                           "export/svg/useTransparency");
static const Settings::Key EXPORT_SVG_ILLUSTRATOR_COMPAT("iex_imagesexport",
                                                         "export/svg/illustratorCompat");
