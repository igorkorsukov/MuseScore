...
public:
    ...
    muse::Ret write(project::INotationProjectPtr project, QIODevice& device,
...
private:
    ...
    muse::Ret generatePagedOriginalVideo(project::INotationProjectPtr project,
                                         const muse::io::path_t& filePath, const Config& config);
};
}
