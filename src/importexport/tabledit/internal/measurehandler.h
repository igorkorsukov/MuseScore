...
public:
    ...
    void calculate(const std::vector<TefNote>& tefContents,
...
private:
    ...
    void updateGapLeft(std::vector<int>& gapLeft, const int position,
                       const std::vector<TefMeasure>& tefMeasures);
    void updateGapRight(std::vector<int>& gapRight, const TefNote& note,
                        const std::vector<TefMeasure>& tefMeasures);
    void updateGaps(const std::vector<TefNote>& tefContents,
                    const std::vector<TefMeasure>& tefMeasures);
